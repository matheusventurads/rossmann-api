...
class Rossmann(object):
    def __init__(self):
        ...
        self.state_holiday_encoder         = pickle.load(open(self.home_path + 'parameter/state_holiday_encoder.pkl', 'rb'))
    ...
    def data_preparation(self, df5):
        ...
        transformed = self.state_holiday_encoder.transform(df5[['state_holiday']])
        df5[self.state_holiday_encoder.categories_[0]] = transformed.toarray()
        
        # store_type - Label Encoding
        df5['store_type'] = self.store_type_encoder.transform(df5['store'])
